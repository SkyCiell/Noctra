...
import { POPULAR_CITIES, searchCities } from '@/lib/weather/openmeteo';
  ...
  return (
    <header className="relative z-30 flex w-full items-center justify-between px-2.5 py-2.5 sm:px-6 lg:px-8 gap-1.5 sm:gap-3">
      ...
      <div className="flex items-center gap-2 sm:gap-2.5">
        ...
        <div className="hidden sm:flex items-center gap-2 rounded-full bg-white/5 px-3.5 py-1.5 backdrop-blur-xl border border-white/10 shadow-md">
          {isDaytime ? (
        ...
        <button
          ...
          className="flex h-9 w-9 items-center justify-center rounded-full bg-white/5 text-xs font-semibold text-white/80 backdrop-blur-xl border border-white/10 transition hover:bg-white/15 hover:text-white"
        ...
        <button
          ...
          className="flex h-9 w-9 items-center justify-center rounded-full bg-white/5 text-white/80 backdrop-blur-xl border border-white/10 transition hover:bg-white/15 hover:text-white"
          title="World Clock & Saved Cities"
        >
          <Globe className="h-4 w-4" />
        </button>

        {/* Ambient Soundboard Opener */}
        <button
        ...
        {/* Media & Atmosphere Selector */}
        <button
          onClick={onOpenMediaSelector}
          className="flex h-9 w-9 items-center justify-center rounded-full bg-white/5 text-white/80 backdrop-blur-xl border border-white/10 transition hover:bg-white/15 hover:text-white"
          title="Visual & Music Atmosphere Studio"
        >
        ...
        <button
          ...
          className="hidden md:flex h-9 w-9 items-center justify-center rounded-full bg-white/5 text-white/80 backdrop-blur-xl border border-white/10 transition hover:bg-white/15 hover:text-white"
